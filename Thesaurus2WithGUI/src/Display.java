...
//	       
	        ...
	        JFrame frameText = new JFrame("Passages that relate to user theme");//"BorderLayoutDemo"); 
...
//	        sortedMap2.putAll(lines);
//	        System.out.println("**************************************");
//	        for (Map.Entry<Double, TextObject> entry : sortedMap2.entrySet()) {
//	        	if(entry.getKey() > 0.0) {
//	        		textBox.append("Line Number " +  entry.getValue().getLineNum() + ": "
//	  	        		  +  entry.getValue().getLine() + "\r\n");
////	        		+ displayToConsole;
////	        		
////	        		System.out.println(displayToConsole);
//	        		
//	          System.out.println("Line Number " +  entry.getValue().getLineNum() + ": "
//	        		  +  entry.getValue().getLine());
//}
//	         //   System.out.println("Key : " + entry.getKey() 
//	              //                        + " Value : " + entry.getValue().getLine());
//	        	}
//	        
//	        System.out.println();
			}  
